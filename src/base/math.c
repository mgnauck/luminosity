...
// credits:
// https://stackoverflow.com/questions/71336291/fastest-way-to-get-square-root-in-float-value
...
float exp2f(float x)
{
  ...
  r = 0.9999999916728642f +
      t * (0.6931471805599453f +
           t * (0.2402265069591007f +
                t * (0.0555041086648216f +
                     t * (0.0096181291076285f + t * 0.0013333558146428f))));
